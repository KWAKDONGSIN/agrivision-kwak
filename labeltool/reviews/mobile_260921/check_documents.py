...
base='http://127.0.0.1:5812';b=L.browser(base=base);out=[]
try:
 for name in ['how_to.html','mobile_done.html']:
  path='/static/'+name
  ...
  L.chk(name+' 폰390·17px·넘침없음·사진정상',r['width']==390 and r['scroll']<=390 and r['font']>=17 and r['images'],r);out.append(dict(page=name,**r));b.shot('/home/kds0206/ff_shots/mobile_260921/document_'+name+'.png')
finally:b.close()
(C/'evidence/documents.json').write_text(json.dumps(out,ensure_ascii=False,indent=2));sys.exit(bool(L.summary('mobile')))
