...
# 쓰는 곳: python3 cycles/260922_툴_간편화/prepare_public.py [대상폴더]
...
for name in ('plan.md', 'checklist.md', 'context-notes.md', 'prepare_public.py'):
    add(C / name, Path('labeltool/reviews/간편화_260922') / name, doc=name.endswith('.md'))
...
if MARK[3:] not in s:
    p.write_text(s + f'\n{MARK[3:]}: reviews/간편화_260922/checklist.md 와 ../docs/260922_툴_기술설명.md 를 읽으세요.\n')
